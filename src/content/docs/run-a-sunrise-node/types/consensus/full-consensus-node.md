---
title: Full Consensus Node
description: Full consensus nodes allow you to sync blockchain history in the Sunrise consensus layer.
---
...
See [Cosmovisor tutorial](/run-a-sunrise-node/types/consensus/setup-cosmovisor)
