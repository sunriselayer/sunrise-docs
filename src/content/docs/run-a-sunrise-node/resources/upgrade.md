---
title: Upgrade
description: Sunrise is upgraded with on-chain governance.
---
...
See [the Cosmovisor tutorial](/run-a-sunrise-node/types/consensus/setup-cosmovisor) for how to set up.
