---
title: How to run Sunrise Rollkit
description: "As an example, here is how to use Rollkit to create an L2 chain and run it on the Sunrise's Data Availability Layer."
---
...
See [Sunrise Data document](/build/l2-blockchains/rollkit/sunrise-data) to set it up.
