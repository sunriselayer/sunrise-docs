---
title: OP Stack L2 Chain
description: "Sunrise's Data Availability Layer supports Layer 2 blockchains created using [OP Stack](https://github.com/ethereum-optimism/optimism)"
---
...
This is a guide to connecting an L2 chain created using OP Stack to Sunrise chain with [Sunrise Data](/build/l2-blockchains/optimism/sunrise-data). Data Availability layer is supported in Sunrise v0.3.0 and later.
