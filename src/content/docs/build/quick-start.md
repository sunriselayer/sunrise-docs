---
title: 🚀 Quick Start
description: Get a local Sunrise DA node, a minimal Rollkit-based sovereign rollup, and a sample dApp running in 20 minutes.
---
...
:::note
For a comprehensive guide covering all aspects of building on Sunrise, including detailed module references, and advanced integration patterns, check out the [Sunrise Builders Kit](https://cauchye.notion.site/Sunrise-Builders-Kit-1e02cd22bc1680f3bebcd4f02f2fbc18?pvs=4).
:::
...
|------|-------|-------------|
| Full client reference | [Client Documentation](/build/client) | Complete API documentation for @sunriselayer/client |
| Build a production Rollkit chain | [Rollkit Guide](/build/l2-blockchains/rollkit) | Guide to deploying a production rollup |
| Validators & DA proofs | [Validators Guide](/build/validators) | Learn about validator setup and DA proof generation |
| Conceptual deep dives | [Learn Section](/learn/sunrise) | Understanding Sunrise's core concepts |
