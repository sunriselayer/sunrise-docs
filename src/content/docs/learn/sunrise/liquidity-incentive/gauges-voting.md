---
title: Gauges Voting
description: "A Gauge in the Sunrise ecosystem is a mechanism that governs the issuance of vRISE tokens. Currently, the primary gauge product is the Liquidity Pool system."
---
