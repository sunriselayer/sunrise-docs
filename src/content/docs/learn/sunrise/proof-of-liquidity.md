...
description: "Proof of Liquidity (PoL) is a novel Sybil resistance mechanism that utilizes a user's history of providing liquidity as the basis for voting power in the network. This approach ..."
---
...
| ------------------ | ---------------------------------------------------------------------------------------------- | ------------------------------------------------------ |
| Security           | ![RISE](/images/RISE.png) RISE + ![vRISE](/images/vRISE.svg) vRISE | Both vRISE & RISE can be staked for Consensus          |
| Governance         | ![vRISE](/images/vRISE.svg) vRISE                                                | vRISE is used for On-chain governance and Gauge Voting |
| Security Emissions | ![RISE](/images/RISE.png) RISE                                                   | RISE is distributed for stakers as consensus rewards   |
| LP Emissions       | ![vRISE](/images/vRISE.svg) vRISE                                                | vRISE is distributed for LPs as incentives             |
| Fee                | Any (swapped to [Fee Token](/learn/sunrise/fee))                                                           | RISE is used as a transaction fee                      |

**Legend:**\
![RISE](/images/RISE.png) = RISE\
![vRISE](/images/vRISE.svg) = vRISE
